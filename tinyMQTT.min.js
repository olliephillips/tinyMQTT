...
setInterval(function(){a.cl&&(a.cl.end(),delete a.cl);a.cl=require("net").connect({host:a.svr,port:a.prt},b)},a.ri)};g.prototype.subscribe=function(b){a.cl.write(h(130,e(256,1),f(b)+e(1)))};g.prototype.publish=function(b,c){if(127<b.length+c.length)throw"Length of topic + data must not be more than 127 characters!";a.cn&&(a.cl.write(h(49,f(b),c)),a.emit("published"))};g.prototype.disconnect=function(){a.cl.write(e(224)+"\x00")};exports.create=function(a,c){return new g(a,c)}})();