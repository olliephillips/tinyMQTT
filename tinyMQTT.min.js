...
MQTT.prototype.connect=function(){client=require("net").connect({host:mq.server,port:mq.port},function(){client.write(mqttConnect(getSerial()));mq.emit("connected");client.on("data",onData.bind(mq));client.on("end",function(){mq.emit("disconnected")})});mq.client=client};MQTT.prototype.subscribe=function(a){mq.client.write(mqttPacket(130,String.fromCharCode(256,1),mqttStr(a)+String.fromCharCode(1)))};MQTT.prototype.publish=function(a,b){mq.client.write(mqttPacket(49,mqttStr(a),b));mq.emit("published")};
MQTT.prototype.disconnect=function(){mq.client.write(String.fromCharCode(224)+"\x00")};exports.create=function(a,b){return new MQTT(a,b)};
