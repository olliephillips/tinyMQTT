...
MQTT.prototype.publish=function(a,b){mq.client.write(mqttPacket(49,mqttStr(a),b));mq.emit("published")};MQTT.prototype.disconnect=function(){mq.client.write(String.fromCharCode(224)+"\x00")};exports.create=function(a){return new MQTT(a)};exports.connect=function(){var a=new MQTT;a.connect();return a};