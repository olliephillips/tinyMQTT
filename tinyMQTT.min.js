...
k.bind(a)),a.cl.on("end",a._scktClosed)}catch(c){a._scktClosed()}};a.cn||a.con||(a.con=setInterval(function(){a.cl&&(a.cl.end(),delete a.cl);try{a.cl=require("net").connect({host:a.svr,port:a.prt},b)}catch(c){a._scktClosed()}},a.ri))};g.prototype.subscribe=function(b){a.cl.write(h(130,e(256,1),f(b)+e(1)))};g.prototype.publish=function(b,c){if(127<b.length+c.length)throw"tMQTT-TL";a.cn&&(a.cl.write(h(49,f(b),c)),a.emit("published"))};g.prototype.disconnect=function(){if(a.cn)try{a.cl.write(e(224,0))}catch(b){a._scktClosed()}};
